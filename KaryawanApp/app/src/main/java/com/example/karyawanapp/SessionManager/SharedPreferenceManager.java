...
import com.example.karyawanapp.constants.AppConstans;
import com.example.karyawanapp.model.UserModel;
...
public class SharedPreferenceManager {
    ...
    public void saveUserModel(UserModel userModel)
    {
        ...
        setStringInPreferences(AppConstans.SharedPreferenceKeys.USER_NAME.getKey(), userModel.userName);
        setStringInPreferences(AppConstans.SharedPreferenceKeys.USER_EMAIL.getKey(), userModel.userEmail);
        setStringInPreferences(AppConstans.SharedPreferenceKeys.USER_IMAGE_URL.getKey(), userModel.profilePic);
    }

    public UserModel getUserModelFromPreferences()
    {
        UserModel userModel =null;
        String name = getStringFromPreferances(AppConstans.SharedPreferenceKeys.USER_NAME.getKey());
        if(!TextUtils.isEmpty(name)) {
            userModel = new UserModel();
            userModel.userName = name;
            userModel.userEmail = getStringFromPreferances(AppConstans.SharedPreferenceKeys.USER_EMAIL.getKey());
            userModel.profilePic = getStringFromPreferances(AppConstans.SharedPreferenceKeys.USER_IMAGE_URL.getKey());
